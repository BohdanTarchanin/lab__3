...
class MenuScreen(Screen):
    def __init__(self, **kw):
        ...
        box.add_widget(Button(text='Список записів', on_press=lambda x:
                              set_screen('list_budget')))
        box.add_widget(Button(text='Додати запис',
...
class AddOutcome(Screen):
    ...
    def __init__(self, **kw):
        ...
        btn1 = Button(text="Додати запис", size_hint_y=None, height=dp(40))
...
class MyNotebookApp(App):
    def __init__(self, **kvargs):
        super(MyNotebookApp, self).__init__(**kvargs)
    ...
    def get_application_config(self):
        return super(MyNotebookApp, self).get_application_config(
